            ...
            if "营运任务维护表" in f:
                ...
                for i in range(2, count):
                    ...
                    if sheet[mark + str(i)] == "待开立北京市场账户" or "未开立股转账户":
                        ...
                        if salepart not in listLOne[2]:
                            listLOne[2][salepart] = 1
                        else:
                            listLOne[2][salepart] = listLOne[2][salepart] + 1
                    else:
                        continue
...
if __name__ == "__main__":
    ...
    relate_dict = {}
    for i in range(len(relate_sheet['A'])):
        relate_dict[relate_sheet['A']].value = relate_sheet['B'].value
